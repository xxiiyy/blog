...
public class PageUtils {
    ...
    public static String getPagination(int currentPageNo,String action,int maxPageNo){
        ...
        if(currentPageNo != 1){
            sb.append(" <a class=\"extend prev\" rel=\"prev\" href=\"/blog/"+action+"?pageNo="+(currentPageNo-1)+"\">\n" +
        ...
        if(currentPageNo != maxPageNo){
            sb.append("<a class=\"extend next\" rel=\"next\" href=\"/blog/"+action+"?pageNo="+(currentPageNo+1)+"\">\n" +
                    "\t\t<div class=\"next-text\">\n" +
